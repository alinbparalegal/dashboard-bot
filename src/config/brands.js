...
const BRANDS = [
  {
    ...
    fechaPagoFieldId: process.env.GHL_CYA_FECHA_PAGO_FIELD_ID,
    tramites: [
  ...
  },
  {
    ...
    fechaPagoFieldId: process.env.GHL_ETH_FECHA_PAGO_FIELD_ID,
  ...
  },
  {
    ...
    fechaPagoFieldId: process.env.GHL_ETV_FECHA_PAGO_FIELD_ID,
  ...
  },
  {
    ...
    fechaPagoFieldId: process.env.GHL_NAC_FECHA_PAGO_FIELD_ID,
    tramites: [
      'trabajo_cuenta_ajena', 'arraigos', 'profesional_altamente_cualificado', 'nomada_digital',
      'familiar', 'familiar_comunitario', 'no_lucrativa', 'residencia_de_emprendedor',
      'visa_de_estudios', 'residencia_cuenta_propia_inicial', 'reagrupacion_familiar',
  ...
  },
  {
    ...
    fechaPagoFieldId: process.env.GHL_MNEE_FECHA_PAGO_FIELD_ID,
